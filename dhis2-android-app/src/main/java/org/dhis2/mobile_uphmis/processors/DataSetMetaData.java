...
import org.dhis2.mobile_uphmis.io.holders.DataElementOperand;
...
public class DataSetMetaData {
    ...
    private static ArrayList<Field> getValidatedFieldList(
        ...
        //@Sou skip M7 check
//        if (group.getLabel().contains("M7") || group.getLabel().contains("M3"))
//        {
            for (int i = 0; i < group.getFields().size(); i++) {
                validFields.add(group.getFields().get(i));
            }
//        }
//        else
//        {
